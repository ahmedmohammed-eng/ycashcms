(function () {
    ...
    mw.settings = {
        ...
        template_url: 'http://127.0.0.1:8000/userfiles/templates/microweber-whitelabel/',
        ...
        edit_area_placeholder: '<div class="empty-element-edit-area empty-element ui-state-highlight ui-sortable-placeholder"><span>الرجاء سحب العناصر هنا</span></div>',
        empty_column_placeholder: '<div id="_ID_" class="empty-element empty-element-column">الرجاء سحب العناصر هنا</div>',
        handles: {
            item: "<div title='انقر لتحديد هذا العنصر.' class='mw_master_handle' id='items_handle'></div>"
        },
        sorthandle_delete_confirmation_text: "هل أنت متأكد أنك تريد حذف هذا العنصر?"
    }
    ...
    mw.msg = mw._lang = {
        ...
        contentunpublished: "المحتوى غير منشور",
        ...
        remove: "إزالة",
        close: "إغلاق",
        to_delete_comment: "هل أنت متأكد أنك تريد حذف هذا التعليق",
        del: "هل أنت  متأكد أنك تريد حذف هذا?",
        save_and_continue: "احفظ &amp;amp; متابعة",
        before_leave: "غادر دون حفظ",
        session_expired: "انتهت صلاحية جلسة العمل الخاصة بك",
        login_to_continue: "الرجاء تسجيل الدخول للمتابعة",
        more: "أكثر",
        templateSettingsHidden: "إعدادات القالب",
        less: "أقل",
        product_added: "المنتج الخاص بك يضاف إلى عربة التسوق",
        no_results_for: "لا توجد نتائج لـ",
        switch_to_modules: 'قم بالتبديل إلى الوحدات النمطية',
        switch_to_layouts: 'قم بالتبديل إلى التخطيطات',
        loading: 'جار التحميل',
        edit: 'تعديل',
        change: 'يتغيرون',
        submit: 'يقدم',
...
mw.askusertostay = false;
  ...
  if (top === self){
    window.onbeforeunload = function() {
      if(mw.askusertostay){
        mw.notification.warning("لم تحفظ التغييرات!");
        return "لم تحفظ التغييرات!";
      }
    }
  }

  warnOnLeave = function(){
     mw.tools.confirm("لم تحفظ التغييرات! هل أنت متأكد?");
  };
