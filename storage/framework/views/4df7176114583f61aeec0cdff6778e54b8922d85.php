                    ...
                    <div class="mb-3">
                        <div class="js-comment-body-text"><?php echo e($comment['comment_body']); ?></div>
                        <span class="js-comment-body-textarea" style="display: none;">
                            <small class="text-muted">Comment:</small>
                            <textarea name="comment_body" class="form-control"><?php echo e($comment['comment_body']); ?>§</textarea>
                        </span>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\microweber-master\src\MicroweberPackages\Comment/resources/views/admin/comments/comment_item.blade.php ENDPATH**/ ?>